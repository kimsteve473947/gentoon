        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">💰 비용 90% 절감</h3>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={() => router.push('/pricing')}>
              <CardHeader>
                ...
                <div className="text-sm text-muted-foreground">약 600원 상당의 이미지 생성 무료 제공</div>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2">
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4 text-green-500" />
                    <span className="text-sm">8장 이미지 생성 (1만 토큰)</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4 text-green-500" />
                  ...
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4 text-green-500" />
                    <span className="text-sm">일일 3장 한도</span>
                  </li>
                </ul>
                <Button 
            ...
            <Card className="border-purple-500 relative cursor-pointer hover:shadow-lg transition-shadow" onClick={() => router.push('/pricing')}>
              ...
              <CardHeader>
                ...
                <div className="text-sm text-green-600 font-semibold">월 3만원으로 3만원 상당 이미지 생성</div>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2">
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4 text-green-500" />
                    <span className="text-sm">387장 이미지 생성 (50만 토큰)</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4 text-green-500" />
                  ...
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4 text-green-500" />
                    <span className="text-sm">일일 20장 한도</span>
                  </li>
                </ul>
            ...
            <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={() => router.push('/pricing')}>
              <CardHeader>
                ...
                <CardDescription>🏢 이미지당 65원 - 대용량 기업용</CardDescription>
                <div className="text-3xl font-bold mt-4">₩100,000<span className="text-base font-normal">/월</span></div>
                <div className="text-sm text-green-600 font-semibold">월 10만원으로 12만원 상당 이미지 생성</div>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2">
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4 text-green-500" />
                    <span className="text-sm">1,550장 이미지 생성 (200만 토큰)</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4 text-green-500" />
                  ...
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4 text-green-500" />
                    <span className="text-sm">일일 60장 한도</span>
                  </li>
                </ul>
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-pink-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="bg-white/20 rounded-lg p-4 mb-8 max-w-md mx-auto">
            <p className="text-white font-semibold">🎁 지금 AI 디자이너 고용하면</p>
            <p className="text-white/90">무료 8장 이미지 + 1만 토큰 증정</p>
          </div>
          <Button 
            size="lg" 
            variant="secondary" 
