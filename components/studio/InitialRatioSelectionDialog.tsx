...
const CANVAS_SIZES = {
  '4:5': { label: '4:5', actualWidth: 1080, actualHeight: 1350, description: '인스타그램 스토리에 최적화된 세로형 비율' },
  '1:1': { label: '1:1', actualWidth: 1080, actualHeight: 1080, description: '인스타그램 정사각형 포스트 비율' },
};
